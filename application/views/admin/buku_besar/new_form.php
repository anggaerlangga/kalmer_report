    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Add Buku Besar</h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('admin/buku_besar/add') ?>" method="post" enctype="multipart/form-data" >    
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('tgl_transaksi') ? 'is-invalid':'' ?>"
                                                type="date" name="tgl_transaksi" id="tgl_transaksi" placeholder="Tanggal Transaksi" />
