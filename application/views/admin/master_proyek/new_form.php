    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Add Proyek</h1>
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('no_proyek') ? 'is-invalid':'' ?>"
                                                type="text" name="no_proyek" placeholder="No Proyek" />
                                    ...
                                    <div class="col-sm">                           
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('pelaksana') ? 'is-invalid':'' ?>"
                                                type="text" name="pelaksana" placeholder="Pelaksana Proyek" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('status_proyek') ? 'is-invalid':'' ?>"
                                                type="date" name="tgl_mulai" placeholder="" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('tgl_selesai') ? 'is-invalid':'' ?>"
                                                type="date" name="tgl_selesai" placeholder="" />
                                            <div class="invalid-feedback">
