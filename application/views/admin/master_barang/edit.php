    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Edit Master Barang</h1>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" >  
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('tipe_barang') ? 'is-invalid':'' ?>"
                                    type="text" name="tipe_barang" placeholder="Tipe Barang" value="<?php echo $barang->tipe_barang ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('merk_barang') ? 'is-invalid':'' ?>"
                                    type="text" name="merk_barang" placeholder="Merk Barang" value="<?php echo $barang->merk_barang ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('id_barang') ? 'is-invalid':'' ?>"
                                    type="text" name="id_barang" placeholder="Kode Barang" value="<?php echo $barang->id_barang ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('satuan') ? 'is-invalid':'' ?>"
                                    type="text" name="satuan" placeholder="Satuan" value="<?php echo $barang->satuan ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('kuantitas') ? 'is-invalid':'' ?>"
                                    type="text" name="kuantitas" placeholder="Quantity" value="<?php echo $barang->kuantitas ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama_suplier') ? 'is-invalid':'' ?>"
                                    type="text" name="nama_suplier" placeholder="Nama Suplier" value="<?php echo $barang->nama_suplier ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('harga_satuan') ? 'is-invalid':'' ?>"
                                    type="text" name="harga_satuan" placeholder="Harga Satuan" value="<?php echo $barang->harga_satuan ?>" />
                                <div class="invalid-feedback">
