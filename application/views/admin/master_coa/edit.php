    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Edit Master COA</h1>
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('akun') ? 'is-invalid':'' ?>"
                                                type="text" name="akun" id="akun" value="<?php echo $coa->akun?>" placeholder="Akun" />
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" <?php echo form_error('akun') ? 'is-invalid':'' ?>
                                                type="text" name="nama_akun" value="<?php echo $coa->nama_akun?>" placeholder="Nama Akun" />
                                            <div class="invalid-feedback">
