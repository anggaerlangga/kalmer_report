    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Add Master Pekerjaan</h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('admin/pekerjaan/add') ?>" method="post" enctype="multipart/form-data" >
                            
                            <div class="form-group">
                                <label for="id_pekerjaan">Kode Pekerjaan</label>
                                <input class="form-control <?php echo form_error('id_pekerjaan') ? 'is-invalid':'' ?>"
                                    type="text" name="id_pekerjaan" placeholder="Kode Pekerjaan" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('jenis_pekerjaan') ? 'is-invalid':'' ?>"
                                    type="text" name="jenis_pekerjaan" placeholder="Jenis Pekerjaan" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama_pekerjaan') ? 'is-invalid':'' ?>"
                                    type="text" name="nama_pekerjaan" placeholder="Nama Pekerjaan" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('material_spec') ? 'is-invalid':'' ?>"
                                    type="text" name="material_spec" placeholder="Material Spec" />
                                <div class="invalid-feedback">
