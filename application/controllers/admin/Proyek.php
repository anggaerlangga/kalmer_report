...
class Proyek extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        $this->load->view("admin/master_proyek/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("admin/master_proyek/new_form"); // tampilkan form add
    }
    ...
    public function edit($id = null) // id data yang akan diedit
    {
        ...
        $validation->set_rules($proyek->rules()); // menerapkan rules
        ...
        $this->load->view("admin/master_proyek/edit", $data); // menampilkan form edit
    }
